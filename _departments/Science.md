...
Table
<table class="tg" style="border-collapse:collapse;border-spacing:0;table-layout: fixed; width: 889px"><colgroup><col style="width: 83px"><col style="width: 243px"><col style="width: 563px"></colgroup>
