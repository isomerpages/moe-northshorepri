...
1)  Sexuality Education (SEd) in schools aims to enable students to <br> understand the physiological, social and emotional changes they experience as they mature, develop healthy and rewarding <br> relationships with others, including those with members of the <br> opposite sex, and make wise, informed and responsible decisions on <br> sexuality matters. SEd is premised on the importance of the <br> family as the basic unit of society. This means encouraging healthy, <br> heterosexual marriages and stable nuclear family units with <br> extended family support. The teaching and learning of SEd is based on  <br> respect for the values and beliefs of the different ethnic and <br> religious communities in Singapore on sexuality issues.  
